...
class TestPentParserOptlinePatterns(ut.TestCase, SuperPent):
    """Confirming matching of optional-line patterns generated by the Parser."""
    ...
    def test_optional_1line_head(self):
        ...
        for i, t in enumerate(good_texts):
            with self.subTest("good_{}".format(i)):
                self.assertNotEqual([], prs.capture_struct(t))
    ...
    def test_optional_2line_head(self):
        ...
        # is just ignored. NEED TO ROBUSTIFY WITH A CHECK ON THE
        # HEAD CAPTURES!
        good_texts = [
            ("1 2 3", []),
            ("1 2 3\n4 5", []),
